...
nohup python -u train_cifar.py --gpu 0 --arch resnet18 --ReLU_count 1.8 --w_mask_lr 0.01\
 --mask_epochs 50 --epochs 0 --degree 1 --lamda 6.0e1\
...
nohup python -u train_cifar.py --gpu 1 --arch resnet18 --ReLU_count 12.9 --w_mask_lr 0.01\
 --mask_epochs 50 --epochs 0 --degree 1 --lamda 2e1\
 --pretrained_path ./train_cifar/resnet18__cifar10/cosine_baseline_ReLUs0lr0.1ep400_baseline/best.pth.tar\
 --optim cosine --act_type ReLU_masked_dapa_relay --threshold 0.003> ./out/resnet18_mask_train_dapa1_cnt12.9.txt &
### Location of checkpoint file, log file, and tb for tensorboard file are in folder: 
### 

nohup python -u train_cifar.py --gpu 3 --arch resnet18 --ReLU_count 24.9 --w_mask_lr 0.01\
 --mask_epochs 50 --epochs 0 --degree 1 --lamda 1.5e1\
 --pretrained_path ./train_cifar/resnet18__cifar10/cosine_baseline_ReLUs0lr0.1ep400_baseline/best.pth.tar\
 --optim cosine --act_type ReLU_masked_dapa_relay --threshold 0.003> ./out/resnet18_mask_train_dapa1_cnt24.9.txt &
### Location of checkpoint file, log file, and tb for tensorboard file are in folder: 
### 
...
nohup python -u train_cifar.py --gpu 3 --arch resnet18 --ReLU_count 51.2 --w_mask_lr 0.01\
 --mask_epochs 50 --epochs 0 --degree 1 --lamda 1.5e1\
 --pretrained_path ./train_cifar/resnet18__cifar10/cosine_baseline_ReLUs0lr0.1ep400_baseline/best.pth.tar\
 --optim cosine --act_type ReLU_masked_dapa_relay --threshold 0.003> ./out/resnet18_mask_train_dapa1_cnt51.2.txt &
### Location of checkpoint file, log file, and tb for tensorboard file are in folder: 
### 
