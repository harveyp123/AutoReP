...
nohup python -u train_cifar.py --gpu 0 --arch resnet18 --sparsity 0.5 --mask_epochs 0 --mask_dropout 0.01\
 --w_lr 0.01 --w_weight_decay 1e-3 --epochs 100  --threshold 0.001\
 --pretrained_path ./train_cifar_relay/resnet18__cifar10_relay_0.001/cosine_mask_dropout_0.01sp0.5wm_lr0.02mep100_baseline/checkpoint_mask_train.pth.tar\
...
nohup python -u train_cifar.py --gpu 1 --arch resnet18 --sparsity 0.9 --mask_epochs 0 --mask_dropout 0.01\
 --w_lr 0.01 --w_weight_decay 1e-3 --epochs 100  --threshold 0.001\
 --pretrained_path ./train_cifar_relay/resnet18__cifar10_relay_0.001/cosine_mask_dropout_0.01sp0.9wm_lr0.02mep100_baseline/checkpoint_mask_train.pth.tar\
